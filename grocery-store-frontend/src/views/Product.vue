<template>
  <div class="product-container">
    <p class="link">
      <span>Home </span> <RightArrow class="dark-icon" />
      <span>Fresh Vegetable Organic</span>
      <RightArrow class="dark-icon" />Purple Cauliflower
    </p>
    <div class="content">
      <div class="product-info">
        <div class="image">
          <img src="@/assets/images/products/Green-Leaf.jpg" alt="image" />
        ...
        <div class="introduce">
          <div class="item">
            <TrucK class="dark-icon" viewBox="20 0 550 550" />
            <p>
              Free shipping apply to all orders over shipping <span>$100</span>
            </p>
          </div>
          <div class="item">
            <Home class="dark-icon" viewBox="0 0 650 650" />
            <p>Home Delivery within <span>1 Hour</span></p>
          </div>
          <div class="item">
            <Dolar class="dark-icon" viewBox="150 0 950 950" />
            <p>Cash on Delivery Available</p>
          </div>
          <div class="item">
            <Pending class="dark-icon" viewBox="0 -5 35 35" />
            <p><span>7</span> Days returns money back guarantee</p>
          </div>
          <div class="item">
            <Shield class="dark-icon" viewBox="0 -100 600 600" />
          ...
          <div class="item">
            <Location class="dark-icon" viewBox="0 0 400 400" />
            <p>
...
import Dolar from "../assets/Icons/dollar.svg";
