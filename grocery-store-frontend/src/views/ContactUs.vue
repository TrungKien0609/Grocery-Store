<template>
  <div class="contact-us-container">
    ...
    <div class="contact-info">
      <div class="detail">
        <Email class="dark-icon" />
        <h3 class="title">Email Us</h3>
        <p class="description">
          <span>Trungkien7300@gmail.com</span> Interactively grow empowered for
          process-centric total linkage
        </p>
      </div>
      <div class="detail">
        <Phone class="dark-icon rotate" />
        <h3 class="title">Call Us</h3>
        <p class="description">
          <span>0399610609</span> Distinctively disseminate focused solutions
          clicks-and-mortar ministate.
        </p>
      </div>
      <div class="detail">
        <Location class="dark-icon" />
        <h3 class="title">Location</h3>
        <p class="description">TP.Đà Nẵng, Việt Nam</p>
      </div>
    </div>
    <div class="support">
      <div class="image">
        <img src="@/assets/images/banner/contact-us.png" alt="contact-us" />
      </div>
      <div class="form">
