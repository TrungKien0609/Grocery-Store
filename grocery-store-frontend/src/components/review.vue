<template>
  <div class="review-container">
    <div class="header">
      <div class="image">
        <img
          src="@/assets/images/products/Green-Leaf.jpg"
          alt="image"
          style="display: none"
        />
      ...
      <div class="info">
        ...
        <div class="status">
          <Correct class="dark-icon" viewBox="-100 -50 500 500" />
    ...
    <div class="content">
      ...
      <div class="images">
        <div class="image">
          <img src="@/assets/images/products/Green-Leaf.jpg" alt="" />
        </div>
        <div class="image">
          <img src="@/assets/images/products/Green-Leaf.jpg" alt="" />
        </div>
