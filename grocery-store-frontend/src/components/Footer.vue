<template>
  <div class="footer-container">
      ...
      <div class="content">
        ...
        <div class="app-dowload">
          <a href="https://www.apple.com/app-store/" target="blank">
            <AppStore class="app-link" />
          </a>
          <a href="https://play.google.com/store/apps" target="blank">
            <GooglePlay class="app-link" />
          </a>
        </div>
      </div>
      <div class="image">
        <img src="@/assets/images/common-fruit.png" alt="" />
      </div>
    </div>
    <div class="footer-info">
      ...
      <div class="col-3">
        <h3 class="header">Top Category</h3>
        <router-link to="#" class="link-dark">
          <p>Fish & Meat</p>
        </router-link>
        <router-link to="#" class="link-dark">
    ...
    <div class="copy-right">
      ...
      <div class="payment-logo">
        <img src="@/assets/images/payment-logo.png" alt="payment-logo" />
      </div>
    </div>
  </div>
</template>
...
import GooglePlay from "../assets/Icons/play-store.svg";
